// let map;
// let markers = [];
// let bikeLayer;  // ADD: We'll store a global reference to the Bicycling Layer
// let infoWindow; // ADD: We'll store a single InfoWindow instance here
...
//          // ADD: BICYCLING LAYER (initially OFF)
